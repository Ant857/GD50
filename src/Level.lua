...
function Level:init()
    ...
    function beginContact(a, b, coll)
        ...
        if types['Obstacle'] and types['Player'] then
            ...
            --show that the alien hit something and can no longer spawn two more aliens
            hit = true
...
function Level:update(dt)
    ...
    if self.launchMarker.launched then
        ...
        if tripled == false then
        -- if we fired our alien to the left or it's almost done rolling, respawn
            if xPos < 0 or (math.abs(xVel) + math.abs(yVel) < 1.5) then
                self.launchMarker.alien.body:destroy()
                self.launchMarker.alien.destroyed = true
                self.launchMarker = AlienLaunchMarker(self.world)
            ...
            if self.launchMarker.alien2 ~= nil then
                if self.launchMarker.alien2.destroyed == false then
                    ...
                    if xPos2 < 0 or (math.abs(xVel2) + math.abs(yVel2) < 1.5) then
                        ...
                        self.launchMarker.alien2.destroyed = true
            ...
            if self.launchMarker.alien3 ~= nil then
                if self.launchMarker.alien3.destroyed == false then
                    ...
                    if xPos3 < 0 or (math.abs(xVel3) + math.abs(yVel3) < 1.5) then
                        ...
                        self.launchMarker.alien3.destroyed = true
