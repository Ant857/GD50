    ...
    void Start () {
		...
		for (int z = 0; z < mazeSize; z++) {
			for (int x = 0; x < mazeSize; x++) {
                ...
                // random chance to spawn anywhere from 0-4 holes
                // will almost always spawn 3 or 4 holes
                // 4 holes is more likely than 3
                if (Random.Range(1, 250) == 1 && holes < 4)
                {
                    holes += 1;
                }
                else
